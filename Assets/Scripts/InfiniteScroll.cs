...
// Code is from the Free InfiniteScroll asset on the Unity asset store: http://u3d.as/bvv
...
public delegate void FreeParallaxElementRepositionLogicFunction(InfiniteScroll p, FreeParallaxElement element, float amount, GameObject obj, Renderer r);
